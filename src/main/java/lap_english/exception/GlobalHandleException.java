...
public class GlobalHandleException extends ResponseEntityExceptionHandler {
    ...
    @ExceptionHandler({UploadFailureException.class, InvalidDataException.class,BadRequestException.class, InvalidFileException.class,ResourceInUseException.class})
